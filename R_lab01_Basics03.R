...
Score2<-read.csv("D:/Assignments/Score2.csv",header=T,sep=",")
anyDuplicated(Score1)
Score1[duplicated(Score1$English1), ]
Score1$English1
...
mdata <- rbind(Score1, Score2)
colnames(Score1)
colnames(Score2)
Score2$English1 <- Score2$English2  
Score2$Math1 <- Score2$Math2 
Score2$Science1 <- Score2$Science2 
Score2$OverallPct1 <- Score2$OverallPct2
Score2$English2 <- NULL
Score2$Math2 <- NULL
Score2$Science2 <- NULL
Score2$OverallPct2 <- NULL
